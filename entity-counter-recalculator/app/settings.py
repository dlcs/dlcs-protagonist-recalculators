...
CLOUDWATCH_CUSTOMER_DIFFERENCE_METRIC_NAME = os.environ.get("CLOUDWATCH_CUSTOMER_DIFFERENCE_METRIC_NAME", "CustomerTotalDelta")
CLOUDWATCH_SPACE_DIFFERENCE_METRIC_NAME = os.environ.get("CLOUDWATCH_SPACE_DIFFERENCE_METRIC_NAME", "SpaceTotalDelta")
CLOUDWATCH_CUSTOMER_DELETE_METRIC_NAME = os.environ.get("CLOUDWATCH_CUSTOMER_DELETE_METRIC_NAME", "SpaceDeleteMetrics")
